    ...
    while (true) {
      ...
      case FLOAT:
        jj_consume_token(FLOAT);
            System.out.println("Palavra reservada: Type [float]");
        break;
      case INT:
        jj_consume_token(INT);
          System.out.println("Palavra reservada: Type [int]");
        break;
      case PV:
        jj_consume_token(PV);
      ...
      case PRINT:
        jj_consume_token(PRINT);
            System.out.println("Palavra reservada: Sa\u00edda padr\u00e3o");
        break;
      case AT:
        jj_consume_token(AT);
      ...
      case FUNC:
        jj_consume_token(FUNC);
           System.out.println("Chamada de fun\u00e7\u00e3o: def");
        break;
      case TRUE:
      ...
      case READIO:
        jj_consume_token(READIO);
             System.out.println("Palavra reservada: Entrada padr\u00e3o");
        break;
      case BOOL:
        jj_consume_token(BOOL);
           System.out.println("Palavra reservada: Type [bool]");
        break;
      default:
        jj_la1[1] = jj_gen;
        jj_consume_token(-1);
